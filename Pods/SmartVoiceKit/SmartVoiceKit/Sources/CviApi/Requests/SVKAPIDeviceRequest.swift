 ...
 */
public struct SVKAPIDeviceRequest: SVKAPIRequestProtocol {
    ...
    typealias DecodingTypeGET = SVKDevices
    ...
    typealias Identity = SVKAPIDeviceRequest
    
    /// The method
    var method: SVKAPIDeviceRequest.Method
    
    var absoluteQueryString: String {
        return SVKAPIClient.baseURL + "/svhb/devicegateway/api/configuration/v4/device/devices"
    }
    ...
    public init(method: SVKAPIDeviceRequest.Method) {
        self.method = method
    }
}
