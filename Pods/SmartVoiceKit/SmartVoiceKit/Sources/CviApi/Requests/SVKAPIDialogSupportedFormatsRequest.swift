...
public struct SVKAPIDialogSupportedFormatsRequest: SVKAPIRequestProtocol {

    // The request data response is decoded to this type
    typealias DecodingTypeGET = SVKDialogSupportedFormats
    ...
    typealias Identity = SVKAPIDialogSupportedFormatsRequest

    /// The convert to use
    var converter: SVKTextSpeechConverter = .stt

    var absoluteQueryString: String {
        return SVKAPIClient.baseURL + "/cvi/dm/api/v1/invoke/format/\(converter)"
    }
