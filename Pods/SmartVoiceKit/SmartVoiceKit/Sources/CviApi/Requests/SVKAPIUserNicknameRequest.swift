...
public struct SVKAPIUserNicknameRequest: SVKAPIRequestProtocol {

    // The request data response is decoded to this type
    typealias DecodingTypeGET = SVKUserNickname
    ...
    typealias Identity = SVKAPIUserNicknameRequest

    var absoluteQueryString: String {
        return SVKAPIClient.baseURL + "/user/api/v1/nickname"
    }
