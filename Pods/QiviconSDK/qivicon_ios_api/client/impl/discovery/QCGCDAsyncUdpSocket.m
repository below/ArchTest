...
@class QCGCDAsyncUdpSendPacket;

NSString *const QCGCDAsyncUdpSocketException = @"QCGCDAsyncUdpSocketException";
NSString *const QCGCDAsyncUdpSocketErrorDomain = @"QCGCDAsyncUdpSocketErrorDomain";

NSString *const QCGCDAsyncUdpSocketQueueName = @"QCGCDAsyncUdpSocket";
NSString *const QCGCDAsyncUdpSocketThreadName = @"QCGCDAsyncUdpSocket-CFStream";

enum QCGCDAsyncUdpSocketFlags
{
...
enum QCGCDAsyncUdpSocketConfig
{
...
@interface QCGCDAsyncUdpSocket ()
{
	...
	QCGCDAsyncUdpSocketReceiveFilterBlock receiveFilterBlock;
	dispatch_queue_t receiveFilterQueue;
	BOOL receiveFilterAsync;
	
	QCGCDAsyncUdpSocketSendFilterBlock sendFilterBlock;
	...
	QCGCDAsyncUdpSendPacket *currentSend;
...
/**
 * The QCGCDAsyncUdpSendPacket encompasses the instructions for a single send/write.
**/
@interface QCGCDAsyncUdpSendPacket : NSObject {
@public
	NSData *buffer;
...
@implementation QCGCDAsyncUdpSendPacket
...
@interface QCGCDAsyncUdpSpecialPacket : NSObject {
@public
//	uint8_t type;
...
@implementation QCGCDAsyncUdpSpecialPacket
...
@implementation QCGCDAsyncUdpSocket
...
- (id)initWithDelegate:(id <QCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq
{
	LogTrace();
...
- (id)initWithDelegate:(id <QCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(dispatch_queue_t)dq socketQueue:(dispatch_queue_t)sq
{
	LogTrace();
	...
	if ((self = [super init]))
	{
		...
		{
			socketQueue = dispatch_queue_create([QCGCDAsyncUdpSocketQueueName UTF8String], NULL);
		}
...
- (void)setDelegate:(id <QCGCDAsyncUdpSocketDelegate>)newDelegate synchronously:(BOOL)synchronously
{
...
- (void)setDelegate:(id <QCGCDAsyncUdpSocketDelegate>)newDelegate
{
	[self setDelegate:newDelegate synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <QCGCDAsyncUdpSocketDelegate>)newDelegate
{
...
- (void)getDelegate:(id <QCGCDAsyncUdpSocketDelegate> *)delegatePtr delegateQueue:(dispatch_queue_t *)delegateQueuePtr
{
	if (dispatch_get_specific(IsOnSocketQueueOrTargetQueueKey))
	{
...
- (void)setDelegate:(id <QCGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue synchronously:(BOOL)synchronously
{
	dispatch_block_t block = ^{
...
- (void)setDelegate:(id <QCGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
	[self setDelegate:newDelegate delegateQueue:newDelegateQueue synchronously:NO];
}

- (void)synchronouslySetDelegate:(id <QCGCDAsyncUdpSocketDelegate>)newDelegate delegateQueue:(dispatch_queue_t)newDelegateQueue
{
...
- (NSError *)badConfigError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:QCGCDAsyncUdpSocketErrorDomain
	                           code:QCGCDAsyncUdpSocketBadConfigError
	                       userInfo:userInfo];
}
...
- (NSError *)badParamError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:QCGCDAsyncUdpSocketErrorDomain
	                           code:QCGCDAsyncUdpSocketBadParamError
	                       userInfo:userInfo];
}
...
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"QCGCDAsyncUdpSocketSendTimeoutError",
	                                                     @"QCGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Send operation timed out", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:QCGCDAsyncUdpSocketErrorDomain
	                           code:QCGCDAsyncUdpSocketSendTimeoutError
	                       userInfo:userInfo];
}

- (NSError *)socketClosedError
{
	NSString *errMsg = NSLocalizedStringWithDefaultValue(@"QCGCDAsyncUdpSocketClosedError",
	                                                     @"QCGCDAsyncUdpSocket", [NSBundle mainBundle],
	                                                     @"Socket closed", nil);
	
	NSDictionary *userInfo = [NSDictionary dictionaryWithObject:errMsg forKey:NSLocalizedDescriptionKey];
	
	return [NSError errorWithDomain:QCGCDAsyncUdpSocketErrorDomain code:QCGCDAsyncUdpSocketClosedError userInfo:userInfo];
}
...
- (NSError *)otherError:(NSString *)errMsg
{
	...
	return [NSError errorWithDomain:QCGCDAsyncUdpSocketErrorDomain
	                           code:QCGCDAsyncUdpSocketOtherError
	                       userInfo:userInfo];
}
...
- (BOOL)connectToHost:(NSString *)host onPort:(uint16_t)port error:(NSError **)errPtr
{
	...
	dispatch_block_t block = ^{ @autoreleasepool {
		...
		QCGCDAsyncUdpSpecialPacket *packet = [[QCGCDAsyncUdpSpecialPacket alloc] init];
...
- (void)maybeConnect
{
	...
	BOOL sendQueueReady = [currentSend isKindOfClass:[QCGCDAsyncUdpSpecialPacket class]];
	
	if (sendQueueReady)
	{
		QCGCDAsyncUdpSpecialPacket *connectPacket = (QCGCDAsyncUdpSpecialPacket *)currentSend;
...
- (void)sendData:(NSData *)data withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	QCGCDAsyncUdpSendPacket *packet = [[QCGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
...
- (void)sendData:(NSData *)data toAddress:(NSData *)remoteAddr withTimeout:(NSTimeInterval)timeout tag:(long)tag
{
	...
	QCGCDAsyncUdpSendPacket *packet = [[QCGCDAsyncUdpSendPacket alloc] initWithData:data timeout:timeout tag:tag];
	packet->addressFamily = [QCGCDAsyncUdpSocket familyFromAddress:remoteAddr];
...
- (void)setSendFilter:(QCGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setSendFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setSendFilter:(QCGCDAsyncUdpSocketSendFilterBlock)filterBlock
            withQueue:(dispatch_queue_t)filterQueue
       isAsynchronous:(BOOL)isAsynchronous
{
	QCGCDAsyncUdpSocketSendFilterBlock newFilterBlock = NULL;
...
- (void)maybeDequeueSend
{
	...
	if (currentSend == nil)
	{
		...
		while ([sendQueue count] > 0)
		{
			...
			if ([currentSend isKindOfClass:[QCGCDAsyncUdpSpecialPacket class]])
			{
				[self maybeConnect];
...
- (void)doPreSend
{
	...
	if (sendFilterBlock && sendFilterQueue)
	{
		...
		if (sendFilterAsync)
		{
			...
			QCGCDAsyncUdpSendPacket *sendPacket = currentSend;
...
- (void)setReceiveFilter:(QCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(dispatch_queue_t)filterQueue
{
	[self setReceiveFilter:filterBlock withQueue:filterQueue isAsynchronous:YES];
}

- (void)setReceiveFilter:(QCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous
{
	QCGCDAsyncUdpSocketReceiveFilterBlock newFilterBlock = NULL;
	dispatch_queue_t newFilterQueue = NULL;
...
+ (void)listenerThread
{
	@autoreleasepool {
		...
		[[NSThread currentThread] setName:QCGCDAsyncUdpSocketThreadName];
...
+ (void)addStreamListener:(QCGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
...
+ (void)removeStreamListener:(QCGCDAsyncUdpSocket *)asyncUdpSocket
{
	LogTrace();
	NSAssert([NSThread currentThread] == listenerThread, @"Invoked on wrong thread");
...
{
	@autoreleasepool {
		QCGCDAsyncUdpSocket *asyncUdpSocket = (__bridge QCGCDAsyncUdpSocket *)pInfo;
