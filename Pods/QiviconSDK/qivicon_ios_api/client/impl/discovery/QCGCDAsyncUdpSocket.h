...
extern NSString *const QCGCDAsyncUdpSocketException;
extern NSString *const QCGCDAsyncUdpSocketErrorDomain;

extern NSString *const QCGCDAsyncUdpSocketQueueName;
extern NSString *const QCGCDAsyncUdpSocketThreadName;

typedef NS_ENUM(NSInteger, QCGCDAsyncUdpSocketError) {
	QCGCDAsyncUdpSocketNoError = 0,          // Never used
	QCGCDAsyncUdpSocketBadConfigError,       // Invalid configuration
	QCGCDAsyncUdpSocketBadParamError,        // Invalid parameter was passed
	QCGCDAsyncUdpSocketSendTimeoutError,     // A send operation timed out
	QCGCDAsyncUdpSocketClosedError,          // The socket was closed
	QCGCDAsyncUdpSocketOtherError,           // Description provided in userInfo
};
...
@class QCGCDAsyncUdpSocket;

@protocol QCGCDAsyncUdpSocketDelegate
@optional
...
**/
- (void)udpSocket:(QCGCDAsyncUdpSocket *)sock didConnectToAddress:(NSData *)address;
...
**/
- (void)udpSocket:(QCGCDAsyncUdpSocket *)sock didNotConnect:(NSError *)error;

/**
 * Called when the datagram with the given tag has been sent.
**/
- (void)udpSocket:(QCGCDAsyncUdpSocket *)sock didSendDataWithTag:(long)tag;

/**
 * Called if an error occurs while trying to send a datagram.
 * This could be due to a timeout, or something more serious such as the data being too large to fit in a sigle packet.
**/
- (void)udpSocket:(QCGCDAsyncUdpSocket *)sock didNotSendDataWithTag:(long)tag dueToError:(NSError *)error;

/**
 * Called when the socket has received the requested datagram.
**/
- (void)udpSocket:(QCGCDAsyncUdpSocket *)sock didReceiveData:(NSData *)data
...
**/
- (void)udpSocketDidClose:(QCGCDAsyncUdpSocket *)sock withError:(NSError *)error;
 ...
 * Example:
 * 
 * QCGCDAsyncUdpSocketReceiveFilterBlock filter = ^BOOL (NSData *data, NSData *address, id *context) {
 * 
 ...
 * 
**/
typedef BOOL (^QCGCDAsyncUdpSocketReceiveFilterBlock)(NSData *data, NSData *address, id __nullable * __nonnull context);
 ...
 *
**/
typedef BOOL (^QCGCDAsyncUdpSocketSendFilterBlock)(NSData *data, NSData *address, long tag);


@interface QCGCDAsyncUdpSocket : NSObject

/**
 * QCGCDAsyncUdpSocket uses the standard delegate paradigm,
...
- (instancetype)initWithDelegate:(nullable id <QCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWithDelegate:(nullable id <QCGCDAsyncUdpSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;

#pragma mark Configuration

- (nullable id <QCGCDAsyncUdpSocketDelegate>)delegate;
- (void)setDelegate:(nullable id <QCGCDAsyncUdpSocketDelegate>)delegate;
- (void)synchronouslySetDelegate:(nullable id <QCGCDAsyncUdpSocketDelegate>)delegate;
...
- (void)getDelegate:(id <QCGCDAsyncUdpSocketDelegate> __nullable * __nullable)delegatePtr delegateQueue:(dispatch_queue_t __nullable * __nullable)delegateQueuePtr;
- (void)setDelegate:(nullable id <QCGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
- (void)synchronouslySetDelegate:(nullable id <QCGCDAsyncUdpSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;

/**
 * By default, both IPv4 and IPv6 are enabled.
 * 
 * This means QCGCDAsyncUdpSocket automatically supports both protocols,
 * and can send to IPv4 or IPv6 addresses,
 * as well as receive over IPv4 and IPv6.
 * 
 * For operations that require DNS resolution, QCGCDAsyncUdpSocket supports both IPv4 and IPv6.
 * If a DNS lookup returns only IPv4 results, QCGCDAsyncUdpSocket will automatically use IPv4.
 * If a DNS lookup returns only IPv6 results, QCGCDAsyncUdpSocket will automatically use IPv6.
 ...
 * This is due to the fact that QCGCDAsyncUdpSocket does NOT copy the data.
 ...
 *    or the system tools to handle this aren't available (e.g. on a mobile device).
 * 
 * For more information about QCGCDAsyncUdpSocketSendFilterBlock, see the documentation for its typedef.
...
**/
- (void)setSendFilter:(nullable QCGCDAsyncUdpSocketSendFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
...
**/
- (void)setSendFilter:(nullable QCGCDAsyncUdpSocketSendFilterBlock)filterBlock
 ...
 * 
 * Important Note:
 * QCGCDAsyncUdpSocket may be running in parallel with your code.
 * That is, your delegate is likely running on a separate thread/dispatch_queue.
 * When you invoke this method, QCGCDAsyncUdpSocket may have already dispatched delegate methods to be invoked.
 ...
 * [udpSocket setReceiveFilter:filter withQueue:myParsingQueue];
 * 
 * For more information about QCGCDAsyncUdpSocketReceiveFilterBlock, see the documentation for its typedef.
 * To remove a previously set filter, invoke this method and pass a nil filterBlock and NULL filterQueue.
 * 
 * Note: This method invokes setReceiveFilter:withQueue:isAsynchronous: (documented below),
 *       passing YES for the isAsynchronous parameter.
**/
- (void)setReceiveFilter:(nullable QCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock withQueue:(nullable dispatch_queue_t)filterQueue;
 ...
 * For example, you can't query properties on the socket.
**/
- (void)setReceiveFilter:(nullable QCGCDAsyncUdpSocketReceiveFilterBlock)filterBlock
               withQueue:(nullable dispatch_queue_t)filterQueue
          isAsynchronous:(BOOL)isAsynchronous;
 ...
 * 
 * The QCGCDAsyncUdpSocket instance may optionally be used again.
 ...
 * 
 * Generally QCGCDAsyncUdpSocket doesn't use CFStream. (It uses the faster GCD API's.)
